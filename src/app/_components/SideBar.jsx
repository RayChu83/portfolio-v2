    ...
    <>
      <div
        className={`fixed bg-gray-100 top-0 bottom-0 ${
          barOpened ? "left-0" : "sm:left-[-250px] left-[-100%]"
        } sm:w-[250px] w-full overflow-y-auto text-center drop-shadow-md transition-left duration-500 z-40`}
      >
        <section className="mt-28 flex flex-col items-center rounded-md py-3">
          <DrawerOpen>
            <article
              key={portfolio.imageSrc}
              className="bg-[--primary-color] w-full p-3 flex items-center justify-start gap-3 drop-shadow-lg cursor-pointer hover:opacity-95"
